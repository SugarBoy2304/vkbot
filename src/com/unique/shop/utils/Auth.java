...
public class Auth {
    ...
    public static String getUrl(String api_id, VkApiClient vk) {
        String url = "https://oauth.vk.com/authorize?client_id=" + api_id + "&display=mobile&scope=" + getSettings() + "&redirect_uri=" + URLEncoder.encode(redirect_url) + "&response_type=token"
